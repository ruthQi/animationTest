...
function(t) {
   ...
   }, i.m = t, i.c = n, i.p = "//staticbj.im20.com.cn/VML_INTERNAL/vml_show/v1525681908!/impublic/zwj/built/", i(0)
}({
   0: function(t, i, e) {
      (function(t, i, n) {
            ...
            l = t.extend({}, t.Events, {
               init: function() {
                  this.$main = $("#main"), h.init(), u.init(this.$main), this.stage = new i.Stage({
                     el: $("#three")[0]
                  }), this.stage.size(640, window.innerHeight).update(), this.root = new i.Sprite, this.root.position(0, 0, -600).update(), this.stage.addChild(this.root), s.init(this.root), this.resize(), this.ready()
               },
               isReady: !1,
               ready: function() {
                  if (!this.isReady) {
      ...
      (function(o) {
         ...
         function(r) {
            ...
            var v = function(t, i, e, n, a) {
                  if (t._events = g(m, t._events || {}, i, e, {
                     context: n,
                     ctx: t,
                     listening: a
                  }), a) {
            ...
            f.listenTo = function(t, i, e) {
               if (!t) return this;
               var n = t._listenId || (t._listenId = d("l")),
            ...
            h(V.prototype, f, {
               ...
               _ensureElement: function() {
                  if (this.el) this.setElement(r(this, "el"));
                  else {
            ...
            Q.started = !1, h(Q.prototype, f, {
               ...
               matchRoot: function() {
                  var t = this.decodeFragment(this.location.pathname),
                     i = t.slice(0, this.root.length - 1) + "/";
                  return i === this.root
               },
               ...
               navigate: function(t, i) {
                  ...
                  if (t = this.decodeFragment(t.replace(B, "")), this.fragment !== t) {
                     if (this.fragment = t, this._usePushState) this.history[i.replace ? "replaceState" : "pushState"]({}, document.title, n);
                     else {
   ...
   2: function(t, i, e) {
      ...
      (function(e) {
         ...
         function(o) {
            ...
            function n(t, i) {
               if ("function" == typeof t) i.call(t, 0, t);
               else if (void 0 === t.length) i.call(t, 0, t);
               else for (var e = 0; e < t.length; e++) i.call(t[e], e, t[e])
            }
            function a(t) {
            ...
            function d(t) {
               var i = /(\+=|-=|)(-|)(\d+\.\d+|\d+)(e[+-]?[0-9]{0,2}|)(rem|px|)/i,
                  e = i.exec(t);
               return e ? {
                  num: r(e[2] + e[3] + e[4]),
                  unit: e[5],
            ...
            var k, z, H, L = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame ||
            function(t) {
         ...
         function(r) {
            ...
            return n(r.prototype, {
               ...
               _parseTweenTime: function(t, i, e) {
                  var n = Math.max(t, 0),
                     a = Math.max(i.delay || 0, 0),
                     o = Math.max(0, Math.floor(i.repeat || 0)),
                     r = Math.max(i.repeatDelay || 0, 0),
                     s = a + n + (r + n) * o,
                     h = this._parsePosition(e);
               ...
               _addAnchor: function(t, i) {
                  ...
                  if (e > 0) for (var n = e - 1; n >= 0; n--) {
                     ...
                     if (i >= a.time) return void this.anchors.splice(n + 1, 0, {
                        time: i,
                        handler: t
                     })
                  }
               ...
               _addTween: function(t) {
                  if (void 0 != t.length) for (var i in t) this.tweens.push(t[i]);
                  else this.tweens.push(t)
               },
               _removeTween: function(t) {
                  var i = this.tweens.indexOf(t); - 1 !== i && this.tweens.splice(i, 1)
               },
            ...
            init: function(t) {
               ...
               function u(t) {
                  ...
                  for (var i = C.children.length, e = 0; i > e; e++) {
                     var n = 6 > e ? r.getRandom(50, 150) * t : r.getRandom(150, 250) * t,
                        o = r.getRandom(0, 360),
                        s = o / 180 * Math.PI,
                        h = 1 == t ? r.getRandom(-10, 10) : r.getRandom(-80, 80),
                        u = h / 180 * Math.PI,
                        l = Math.sin(u) * n,
                        c = Math.abs(Math.cos(u) * n);
               ...
               function l() {
                  ...
                  for (var t = f.children.length, i = 0, e = 0; t > e; e++) {
                     var n = r.getRandom(0, 1.5),
                        o = r.getRandom(400, 600),
                        h = r.getRandom(0, 360),
                        l = h / 180 * Math.PI,
                        c = r.getRandom(-80, 80),
                        A = c / 180 * Math.PI,
                        d = Math.sin(A) * o,
                        p = Math.abs(Math.cos(A) * o);
                     a.to(f.children[e], .6, {
                        scaleX: n,
                        scaleY: 1.5 - n,
                        x: Math.cos(l) * p,
               ...
               for (var p = 0; 6 > p; p++) {
                  var g = new n.Plane;
                  g.size(100, 100).rotation(r.getRandom(-180, 180), r.getRandom(-180, 180), r.getRandom(-180, 180)).scale(.01).material({
                     image: e(14)
                  }).update(), f.addChild(g)
               }
               var v = new n.Sprite;
               ...
               for (var p = 0; 3 > p; p++) {
                  var g = new n.Plane,
                     ...
                     y = p * E + 90,
                     I = y / 180 * Math.PI;
                  g.size(2, 210).position(Math.floor(Math.cos(I) * m * 100) / 100, Math.floor(Math.sin(I) * m * 100) / 100, 0).rotation(0, 0, y).material({
                     color: "#fff"
                  }).update(), v.addChild(g)
               }
               var C = new n.Sprite;
               ...
               for (var w = [{
                  ...
                  var V = 5 > p ? p % 3 : (p - 3) % 3 + 3,
                     g = new n.Plane;
                  g.size(w[V].w, w[V].h).scale(.5).material({
                     image: w[V].url
                  }).update(), C.addChild(g)
               }
               var b = new n.Sprite;
