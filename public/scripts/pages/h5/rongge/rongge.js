...
class RonggeTest{
   ...
   initView(){
      this.container = new PIXI.CanvasRenderer(this.width, this.height, {
         backgroundColor: '0xffffff'
      });//Ue
      this.endContainer = new PIXI.CanvasRenderer(this.width, this.height, {
         backgroundColor: '0xffffff'
      });//Ve
      $('#main').append(this.endContainer.view);
      $('#main').append(this.container.view);
